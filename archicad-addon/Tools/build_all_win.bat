...
python download_and_unzip.py https://github.com/GRAPHISOFT/archicad-api-devkit/releases/download/29.2001/API.Development.Kit.WIN.29.2001.zip ..\Build\DevKits\AC29
...
cmake -B ../Build/AC29 -G "Visual Studio 17 2022" -A "x64" -T "v143" -DAC_VERSION=29 -DAC_API_DEVKIT_DIR="..\Build\DevKits\AC29\Support" .. || goto :error
