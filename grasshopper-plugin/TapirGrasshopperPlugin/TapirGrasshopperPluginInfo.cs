...
namespace TapirGrasshopperPlugin
{
    public class TapirGrasshopperPluginInfo : GH_AssemblyInfo
    {
        ...
        public override string Description =>
            "Grasshopper components for connecting to Archicad.";

        public override Guid Id =>
            new Guid("54b11162-627b-455b-b9c0-963e76b36dc7");
        ...
        public override string AssemblyVersion => "1.5.10";
    }
}