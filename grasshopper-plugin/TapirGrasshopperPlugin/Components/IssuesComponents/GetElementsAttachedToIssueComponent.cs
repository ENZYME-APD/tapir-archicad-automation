...
namespace TapirGrasshopperPlugin.Components.IssuesComponents
{
    public class GetElementsAttachedToIssueComponent : ArchicadAccessorComponent
    {
        ...
        {
            pManager.AddGenericParameter ("ElementIds", "ElementIds", "Attached elements of the given issue.", GH_ParamAccess.list);
        }
        ...
        protected override void Solve (IGH_DataAccess DA)
        {
            ...
            CommandResponse response = SendArchicadAddOnCommand ("TapirCommand", "GetElementsAttachedToIssue", parameters);
        ...
        // protected override System.Drawing.Bitmap Icon => TapirGrasshopperPlugin.Properties.Resources.GetAttachedElements;
