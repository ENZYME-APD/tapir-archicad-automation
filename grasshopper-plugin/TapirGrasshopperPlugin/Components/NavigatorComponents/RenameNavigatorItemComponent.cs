...
namespace TapirGrasshopperPlugin.Components.NavigatorComponents
{
    ...
    public class RenameNavigatorItem : ArchicadExecutorComponent
    {
        ...
        {
            pManager.AddGenericParameter ("NavigatorItemId", "NavigatorItemId", "Identifier of a navigator item to rename.", GH_ParamAccess.item);
            pManager.AddTextParameter ("New Name", "NewName", "New name for the navigator item.", GH_ParamAccess.item, @default: "");
            pManager.AddTextParameter ("New Id", "NewId", "New id for the navigator item.", GH_ParamAccess.item, @default: "");
        }
        ...
        protected override void Solve (IGH_DataAccess DA)
        {
            ...
            string newId = "";
            if (!DA.GetData (2, ref newId)) {
                return;
            }

            RenameNavigatorItemInput input = new RenameNavigatorItemInput () {
            ...
            CommandResponse response = SendArchicadCommand ("RenameNavigatorItem", inputObj);
        ...
        protected override System.Drawing.Bitmap Icon => TapirGrasshopperPlugin.Properties.Resources.RenameNavigatorItem;

        public override Guid ComponentGuid => new Guid ("6be1cc4e-6645-400f-b632-1fccdae0db4d");
    }
}