...
__all__ = ['GetElements_Component', 'GetBoundingBox_Component']
...
class GetElements_Component(component):
    ...
    def __new__(cls):
        instance = Grasshopper.Kernel.GH_Component.__new__(cls,
            "GetElements", "GetElements", """Retrieves Element information from connected ArchiCAD project.""", "tAPIr", "Connect")
        return instance
...
class GetBoundingBox_Component(component):
    ...
    def __new__(cls):
        instance = Grasshopper.Kernel.GH_Component.__new__(cls,
            "GetBoundingBox", "BBox", """Retrieves BoundingBox for the provided elements.""", "tAPIr", "Connect")
        return instance
