...
class ExportCode_Component(component):
    ...
    def __new__(cls):
        instance = Grasshopper.Kernel.GH_Component.__new__(cls,
            "ExportCode", "ExportCode", """Extracts code from a GhPython Script component, and provides option to export to .py file.""", "tAPIr", "99 Utility")
        return instance
    ...
    def AppendAdditionalMenuItems(self, items):
        tapir.TapirComponen.AppendAdditionalMenuItems(self , items)
        if self.code == "":
            return
        try:
